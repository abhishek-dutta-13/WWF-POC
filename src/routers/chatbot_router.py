    ...
    try:
        ...
        if not input_safe:
            ...
            return SendMessageResponse(
                ...
                response=(
                    "⚠️ Your message was flagged by our content safety system and could not be processed. "
                    "Please rephrase your question and ensure it does not contain harmful, toxic, or "
