...
class ChatMessageDTO(BaseModel):
    ...
    agent_used: Optional[Literal['rag', 'web_search', 'hybrid', 'pdf_export', 'greeting', 'invalid_query', 'off_topic', 'blocked']] = None
...
class AgentState(BaseModel):
    ...
    agent_route: Optional[Literal['rag', 'web_search', 'hybrid', 'pdf_export', 'greeting', 'invalid_query', 'off_topic', 'blocked']] = None
