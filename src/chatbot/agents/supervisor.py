...
class SupervisorAgent:
    ...
    # Uses word stems where possible so one entry covers all variants:
    # e.g. 'pollut' matches 'pollution', 'polluted', 'polluting', 'pollutant'
    SUSTAINABILITY_KEYWORDS = [
        # Core environmental (stems)
        'environ', 'sustainab', 'conserv',
        'climat', 'global warm', 'greenhouse', 'carbon', 'emission',
        'pollut', 'contaminat', 'toxic', 'effluent', 'sewage',
        'air quality', 'water quality', 'water crisis',
        'soil', 'deforest', 'reforest',
        'biodivers', 'ecosystem', 'habitat', 'species', 'wildlife', 'endanger',
        'ocean', 'marine', 'coral', 'wetland', 'forest', 'rainforest', 'glacier',
        'renewable', 'solar', 'wind energy', 'clean energy', 'fossil fuel', 'net zero',
        'ecological', 'ecology', 'nature',

        # Water bodies & geography (specific rivers, lakes, etc.)
        'river', 'lake', 'ganges', 'ganga', 'yamuna', 'amazon', 'nile', 'groundwater',
        'water scarcity', 'water management', 'drought', 'flood',
        'natural disaster', 'land degrad',
        ...
        'circular economy', 'waste', 'recycl', 'compost', 'plastic', 'e-waste',
        'zero waste', 'upcycl', 'landfill', 'packag',

        # Agriculture & food
        'agricultur', 'farm', 'palm oil', 'sustainable food', 'food waste',
        'organic', 'pesticide', 'irrigation', 'crop', 'soil health',

        # Finance & policy
        'esg', 'green finance', 'sustainable finance', 'carbon credit', 'carbon offset',
        'environmental policy', 'paris agreement', 'cop ', 'kyoto', 'regulat',
        'environmental law', 'sustainability strategy',

        # People & society
        'indigenous', 'green jobs', 'eco-friendly', 'nature-based',
